...
@XmlRootElement(name = "Cancelacion", namespace = "http://www.sat.gob.mx/sitio_internet/cfd")
public class Cancelacion {

    @XmlElement(name = "Folios", namespace = "", required = true)
    ...
    public static class Folios {
        ...
        @XmlElement(name = "Folio", namespace = "", required = true)
